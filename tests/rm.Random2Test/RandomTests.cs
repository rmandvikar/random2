...
namespace rm.Random2Test
{
	...
	public class RandomTests
	{
		...
		public class Verify_Distribution
		{
			...
			[Test]
			public void Verify_Distribution_RandomLocked()
			{
				VerifyDistribution(RandomFactory.GetRandomLocked());
			}

			[Test]
			public void Verify_Distribution_RandomPerThread()
			{
				VerifyDistribution(RandomFactory.GetRandomPerThread());
			}
